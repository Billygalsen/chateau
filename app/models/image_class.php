...
Class Image_class
{
    ...
    /**
     * Fonction permettant de recadrer l'image
    ...
    /**
     * Fonction permettant de retourner un fichier avec une certaine taille passer en paramètre
     * @param $file
     * @param int $width
     * @param int $height
     * @return mixed
